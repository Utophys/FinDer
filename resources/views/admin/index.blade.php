...
@section('content')
        ...
        <div class="bg-[#0E87CC] w-[70%] h-full overflow-y-auto p-8 text-white">
            ...
            <div class="flex flex-wrap gap-6">
                @foreach($fishes as $fish)
                            <div class="text-gray-800 w-64 rounded-lg shadow p-4
                    {{ $fish['is_deleted'] == 1 ? 'bg-red-500' : 'bg-white' }}">
                                ...
                                <div class="my-3">
                                    @if(!empty($fish['IMAGE']))
                                        <img src="{{ asset('storage/' . $fish['IMAGE']) }}" class="w-full rounded" alt="fish image">
                                    @else
    ...
    <div class="modal fade" id="createIkanModal" tabindex="-1">
        <div class="modal-dialog">
            <form method="POST" action="{{ route('admin.ikan.store') }}">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body text-black">
                        <input type="text" name="FISH_ID" class="form-control" placeholder="ID" required>
