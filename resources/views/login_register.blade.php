...
<body class="bg-white w-screen h-screen overflow-hidden">
    <div class="flex h-full w-full" id="auth-container">
        <!-- Login Panel -->
        <div id="login-panel" class="flex h-full w-full transition-transform duration-500">
            <!-- Left Panel White -->
            <div class="w-[60%] bg-white text-black flex flex-col justify-center items-center text-center p-8 relative">
                ...
                <!-- Login Form -->
                <div class="w-full max-w-md border border-gray-300 rounded-lg p-6">
                    <h1 class="text-3xl font-bold text-center mb-2">Selamat Datang Kembali!</h1>
                    <p class="text-center text-gray-500 mb-6">Login Terlebih Dahulu</p>
                    ...
                    <button class="w-full bg-black text-white py-3 rounded-full font-semibold mb-4">Sign In</button>

                    <div class="text-center mb-4 text-gray-500">Or</div>

                    <button class="w-full bg-black text-white py-3 rounded-full flex items-center justify-center">
        ...
        <!-- Register Panel -->
        <div id="register-panel" class="flex h-full w-full hidden transition-transform duration-500">
            <!-- Left Panel Blue -->
            <div class="w-[40%] bg-[#0E87CC] text-white flex flex-col justify-center items-center text-center p-8">
            ...
            <div class="w-[60%] bg-white flex flex-col justify-center items-center p-12 relative">
                ...
                <div class="w-full max-w-md border border-gray-300 rounded-lg p-6">
                    ...
                    <p class="text-center text-gray-500 mb-6">Register Telebih Dahulu</p>
                    ...
                    <button class="w-full bg-black text-white py-3 rounded-full font-semibold mb-4">Sign Up</button>
